/* FWDR3DCarOnOffButton */
(function (window){
var FWDR3DCarOnOffButton = function(bWidth, bHeight, btnWidth, skinPath, value)
{
		var self = this;
		var prototype = FWDR3DCarOnOffButton.prototype;
		...
		{
			self.bgDO = new FWDR3DCarSimpleDisplayObject("img");
			...
			self.btnDO = new FWDR3DCarDisplayObject("div");
			self.addChild(self.btnDO);
			
			self.btnDO.setWidth(btnWidth);
			self.btnDO.setHeight(bHeight);
			
			self.btnSDO = new FWDR3DCarSimpleDisplayObject("img");
			...
			self.btnNDO = new FWDR3DCarSimpleDisplayObject("img");
		...
		this.onMouseOver = function(e)
		{
			...
			{
				FWDR3DCarModTweenMax.to(self.btnNDO, .4, {alpha:0, ease:Expo.easeOut});
			}
		};
		...
		this.onMouseOut = function(e)
		{
			if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE)
			{
				FWDR3DCarModTweenMax.to(self.btnNDO, .4, {alpha:1, ease:Expo.easeOut});
			}
		};
		...
		this.onMouseUp = function(e)
		{
			...
			FWDR3DCarModTweenMax.to(self.btnDO, .2, {x:self.btnCurX, ease:Expo.easeOut});
			
			if (self.value != newVal)
			{
				self.dispatchEvent(FWDR3DCarOnOffButton.CHANGE, {value:newVal});
			}
		...
		this.destroy = function()
		{
			...
			self = null;
			prototype = null;
			FWDR3DCarOnOffButton.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarOnOffButton.setPrototype = function(){
		FWDR3DCarOnOffButton.prototype = new FWDR3DCarDisplayObject("div");
	};
	
	FWDR3DCarOnOffButton.CHANGE = "onChange";
	
	FWDR3DCarOnOffButton.prototype = null;
	window.FWDR3DCarOnOffButton = FWDR3DCarOnOffButton;
}(window));