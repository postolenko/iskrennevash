/* FWDR3DCarPageThumbs */
(function (window){
var FWDR3DCarPageThumbs = function(props_obj){
		
		var self = this;
		var prototype = FWDR3DCarPageThumbs.prototype;
		...
		this.setupThumbs = function()
		{
			...
			{
				FWDR3DCarPageThumb.setPrototype();
				
				thumb = new FWDR3DCarPageThumb(i, 180, 119, self.imagesPath_ar[i] + "N.jpg", self.imagesPath_ar[i] + "S.jpg");
				thumb.addListener(FWDR3DCarPageThumb.CLICK, self.onThumbClick);
		...
		this.onThumbClick = function(e)
		{
			...
			self.dispatchEvent(FWDR3DCarPageThumb.CLICK, {id:self.curId});
		};
	...
	/* set prototype */
	FWDR3DCarPageThumbs.setPrototype = function(){
		FWDR3DCarPageThumbs.prototype = new FWDR3DCarDisplayObject("div");
	};
	
	FWDR3DCarPageThumbs.CLICK = "onClick";

	FWDR3DCarPageThumbs.prototype = null;
	window.FWDR3DCarPageThumbs = FWDR3DCarPageThumbs;
}(window));