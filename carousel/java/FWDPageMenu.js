/* FWDR3DCarPageMenu */
(function (window){
var FWDR3DCarPageMenu = function(props_obj){
		
		var self = this;
		var prototype = FWDR3DCarPageMenu.prototype;
		...
		this.setupButtons = function()
		{
			...
			for(var i=0; i<self.totalButtons; i++){
				...
				FWDR3DCarPageMenuButton.setPrototype();
				button = new FWDR3DCarPageMenuButton(self.menuLabels_ar[i*2], self.menuLabels_ar[i*2 + 1], disableButton_bl);
				button.id = i;
				button.addListener(FWDR3DCarPageMenuButton.CLICK, self.buttonClickHandler);
		...
		this.buttonClickHandler = function(e){
			self.dispatchEvent(FWDR3DCarPageMenuButton.CLICK, {id:e.target.id});
		};
	...
	/* set prototype */
	FWDR3DCarPageMenu.setPrototype = function(){
		FWDR3DCarPageMenu.prototype = new FWDR3DCarDisplayObject("div");
	};
	
	FWDR3DCarPageMenu.CLICK = "onClick";

	FWDR3DCarPageMenu.prototype = null;
	window.FWDR3DCarPageMenu = FWDR3DCarPageMenu;
}(window));