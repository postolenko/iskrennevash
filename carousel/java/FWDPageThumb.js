/* FWDR3DCarPageThumb */
(function (window){
var FWDR3DCarPageThumb = function(id, bWidth, bHeight, nImgUrl, sImgUrl)
{
		var self = this;
		var prototype = FWDR3DCarPageThumb.prototype;
		...
		this.onClick = function(e){
			self.dispatchEvent(FWDR3DCarPageThumb.CLICK, {id:self.id});
		};
		...
		this.enable = function()
		{
			...
			FWDR3DCarModTweenMax.to(self, .1, {alpha:1, ease:Expo.easeOut});
		};
		...
		this.disable = function()
		{
			...
			FWDR3DCarModTweenMax.to(self, .1, {alpha:.2, ease:Expo.easeOut});
		};
		...
		this.destroy = function(){
			...
			self = null;
			prototype = null;
			FWDR3DCarPageThumb.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarPageThumb.setPrototype = function(){
		FWDR3DCarPageThumb.prototype = new FWDR3DCarDisplayObject("div");
	};
	
	FWDR3DCarPageThumb.CLICK = "onClick";
	
	FWDR3DCarPageThumb.prototype = null;
	window.FWDR3DCarPageThumb = FWDR3DCarPageThumb;
}(window));