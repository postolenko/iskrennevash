...
(function(window)
{
	var FWDR3DCarSlider = function(propsObj)
	{
		var self = this;
		var prototype = FWDR3DCarSlider.prototype;
		...
		{
			self.sliderTrackDO = new FWDR3DCarDisplayObject("div");
			...
			self.sliderTrackLeftDO = new FWDR3DCarSimpleDisplayObject("img");
			...
			self.sliderTrackCenterDO = new FWDR3DCarSimpleDisplayObject("div");
			...
			self.sliderTrackRightDO = new FWDR3DCarSimpleDisplayObject("img");
		...
		{
			self.sliderProgressDO = new FWDR3DCarDisplayObject("div");
			...
			self.sliderProgressLeftDO = new FWDR3DCarSimpleDisplayObject("img");
			...
			self.sliderProgressCenterDO = new FWDR3DCarSimpleDisplayObject("div");
		...
		{
			self.sliderHandlerDO = new FWDR3DCarDisplayObject("div");
			...
			self.sliderHandlerSDO = new FWDR3DCarSimpleDisplayObject("img");
			...
			self.sliderHandlerNDO = new FWDR3DCarSimpleDisplayObject("img");
		...
		this.onScrollMouseOver = function()
		{
			...
			FWDR3DCarModTweenMax.to(self.sliderHandlerNDO, .8, {alpha:0, ease : Expo.easeOut});
		};
		...
		this.onScrollMouseOut = function()
		{
			...
			FWDR3DCarModTweenMax.to(self.sliderHandlerNDO, .8, {alpha:1, ease : Expo.easeOut});
		};
		...
		this.onScrollMouseDown = function(e)
		{
			...
			var vmc = FWDR3DCarUtils.getViewportMouseCoordinates(e);
		...
		this.onScrollMove = function(e)
		{
			...
			if (newValue != self.value)
			{
				...
				self.dispatchEvent(FWDR3DCarSlider.CHANGE, {value:self.value});
			}
		};
		...
		this.destroy = function()
		{
			...
			FWDR3DCarModTweenMax.killTweensOf(self.sliderHandlerNDO);
			...
			self = null;
			prototype = null;
			FWDR3DCarSlider.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarSlider.setPrototype = function()
	{
		FWDR3DCarSlider.prototype = new FWDR3DCarDisplayObject("div");
	};

	FWDR3DCarSlider.CHANGE = "onChange";

	FWDR3DCarSlider.prototype = null;
	window.FWDR3DCarSlider = FWDR3DCarSlider;
}(window));